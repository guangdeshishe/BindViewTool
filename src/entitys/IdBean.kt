...
(layout: LayoutManager,
 ...
 private val mCommentsJTextField: JTextField,
 enable: Boolean,
 clickable: Boolean,
 clickEnable: Boolean) : JPanel(layout) {
    ...
    /**
     * mCommendsJTextField接口
     */
    private var mCommentsFocusListener: ((commentsJTextField: JTextField) -> Unit)? = null

    fun setCommentsFocusListener(commentsFocusListener: (commentsJTextField: JTextField) -> Unit) {
        mCommentsFocusListener = commentsFocusListener
    }
    ...
    private fun initComponent(enable: Boolean, clickable: Boolean, clickEnable: Boolean) {
        ...
        mCommentsJTextField.isEnabled = enable;
        ...
        mCommentsJTextField.horizontalAlignment = JTextField.LEFT
        // 监听
        mEnableCheckBox.addActionListener {
            mEnableListener?.let {
                ...
                mCommentsJTextField.isEnabled = mEnableCheckBox.isSelected
            }
        }
        // 监听
        ...
        mCommentsJTextField.addFocusListener(object : FocusListener{
            override fun focusGained(e: FocusEvent?) {
                mCommentsFocusListener?.invoke(mCommentsJTextField)
            }
