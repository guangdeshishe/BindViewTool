...
import views.BindViewToolDialog
import java.util.*

/**
 * @author Jowan
 */
class BindViewToolAction : AnAction() {
    private var mDialog: BindViewToolDialog? = null
...
//        }
        ...
        mDialog = BindViewToolDialog(mEditor = mEditor,
                mProject = project,
                mPsiFile = psiFile,
                mClass = psiClass,
                mElements = elements,
