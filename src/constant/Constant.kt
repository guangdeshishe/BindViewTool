...
object Constant {
    ...
    object Dialog {
        ...
        const val TITLE_FINDVIEWBYID = "BindViewToolDialog"
        const val TABLE_FIELD_VIEW_WIDGET = "组件类型"
        const val TABLE_FIELD_VIEW_ID = "组件Id"
        const val TABLE_FIELD_PARAM_NAME = "生成的变量名"
        const val TABLE_FIELD_COMMENTS = "注释"
